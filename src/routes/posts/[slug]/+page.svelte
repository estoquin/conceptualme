...
<article class="max-w-4xl mx-auto">
	...
	<header class="mb-8">
		...
		<img src={post.image} alt={post.title} class="w-full h-96 object-cover rounded-lg shadow-lg" />
	</header>

	<!-- Post Content -->
	<section class="prose prose-lg max-w-none bg-white rounded-lg shadow-md p-8 md:p-12">
